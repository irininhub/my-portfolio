            ...
            <Fade bottom>
                ...
                <div className={s.conteiner}>
                    ...
                    <form className={s.form}>
                        <input className={s.formData} value ={this.state.name} onChange={this.onNameChange} placeholder='Your name' required />
                        <input className={s.formData} value ={this.state.email} onChange={this.onEmailChange} placeholder='Your E-mail' required />
                        <textarea className={s.message} value ={this.state.message} onChange={this.onInfoChange} placeholder='Your message' required />
                    </form>
